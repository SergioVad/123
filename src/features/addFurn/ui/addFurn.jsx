...
import { addFurniture } from '@/app/store/furniture';
import cls from './addFurn.module.css';
    ...
    return (
        <div className="offset-4 p-3 col-4">
            <Form>
                ...
                <Form.Group className="mb-3">
                    <Form.Label htmlFor="product_image_1">
                        Картинка 1
                    </Form.Label>
                    <Form.Control
                        type="file"
                ...
                <Form.Group className="mb-3">
                    <Form.Label htmlFor="product_image_2">
                        Картинка 2
                    </Form.Label>
                    <Form.Control
                        type="file"
                ...
                <Form.Group className="mb-3">
                    <Form.Label htmlFor="product_image_3">
                        Картинка 3
                    </Form.Label>
                    <Form.Control
                        type="file"
                ...
                <Form.Group className="mb-3">
                    <Form.Label htmlFor="product_image_4">
                        Картинка 4
                    </Form.Label>
                    <Form.Control
                        type="file"
                ...
                <Form.Group className="mb-3">
                    <Form.Label htmlFor="product_image_5">
                        Картинка 5
                    </Form.Label>
                    <Form.Control
                        type="file"
                ...
                <Form.Group className="mb-3">
                    <Form.Label htmlFor="product_image_6">
                        Картинка 6
                    </Form.Label>
                    <Form.Control
                        type="file"
                ...
                <Form.Group className="mb-3">
                    <Form.Label htmlFor="product_image_7">
                        Картинка 7
                    </Form.Label>
                    <Form.Control
                        type="file"
                ...
                <Form.Group className="mb-3">
                    <Form.Label htmlFor="product_image_8">
                        Картинка 8
                    </Form.Label>
                    <Form.Control
                        type="file"
                ...
                <Form.Group className="mb-3">
                    <Form.Label htmlFor="product_image_9">
                        Картинка 9
                    </Form.Label>
                    <Form.Control
                        type="file"
                ...
                <Form.Group className="mb-3">
                    <Form.Label htmlFor="product_image_10">
                        Картинка 10
                    </Form.Label>
                    <Form.Control
                        type="file"
            ...
            <button className={cls.btn} onClick={addDevice}>
                Добавить
            </button>
            {/* </a> */}
        </div>
